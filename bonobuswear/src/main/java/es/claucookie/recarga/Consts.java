...
public class Consts {
    ...
    public static final String GET_FAVORITE_CARD_INFO_UPDATED_MESSAGE = "favorite_card_info_updated";
    ...
    public static final String CARD_DATA_REQUEST_FINISHED = "card_data_request_finished";
}
